#!/usr/bin/python3
# -*- coding: utf-8 -*-
# Created by: python.exe -m py2exe genTex.py -W mysetup.py
...
class Target(object):
    ...
    def __init__(self, **kw):
        ...
        self.company_name = "RKF"
        self.copyright = "RKF © 2018"
        self.legal_copyright = "RKF © 2018"
        # self.legal_trademark = ""
        self.product_version = "1.1.0"
        self.product_name = "HTML Generator"
...
genTex = Target(
    ...
    version = "1.0",
    file_description = "Convertit un tableaur (Classeur1.xls) en documentation HTML/CSS/JS",
    ...
    icon_resources=[(1, r"logo.ico")],

    other_resources = [(RT_MANIFEST, 1, (manifest_template % dict(prog="HTML Generator", level="asInvoker")).encode("utf-8")),
